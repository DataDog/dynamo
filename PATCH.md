...
| _(this commit)_ | Classify request errors from the typed `ErrorType` in the error chain instead of the message text, on both the request and streaming paths |
