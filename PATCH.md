...
| `f98007dc6` | Keep the mid-stream SSE error frame static: typed `Backend(InvalidArgument)` classifies as `validation` for metrics, but its backend text stays server-side (info-disclosure guard) |
